...
/**
 * @Description 雪花ID生成器 https://segmentfault.com/a/1190000011282426
 * @Author ansonzwchen
 * @Date 2020/8/21
 */
public class SnowFlakeGenId {

  private static Logger logger = LoggerFactory.getLogger(SnowFlakeGenId.class);
  ...
  public SnowFlakeGenId(long workerId, long datacenterId, long sequence){
