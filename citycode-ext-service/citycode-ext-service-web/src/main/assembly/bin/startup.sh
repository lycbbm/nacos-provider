...
LOGDIR="/data/logs"
APPID="citycode-ext-service"

MEM_OPTS="-Xms2g -Xmx2g -XX:NewRatio=1"
...
echo "$JAVACMD $JAVA_OPTS  $JAVA_OPTS_EX -classpath $CLASSPATH com.tencent.citycode.ext.CitycodeExtServiceWebApplication $@  2>&1 &"

 exec "$JAVACMD" $JAVA_OPTS  $JAVA_OPTS_EX  \
  -classpath "$CLASSPATH" \
  com.tencent.citycode.ext.CitycodeExtServiceWebApplication "$@"  2>&1 &